...
from ._exceptions import APIStatusError, SeshtahvcodePyCliError
...
class SeshtahvcodePyCli(SyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous SeshtahvcodePyCli client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("SESHTAHVCODE_PY_CLI_BASE_URL")
        if base_url is None:
            base_url = f"https://petstore3.swagger.io/api/v3"

        custom_headers_env = os.environ.get("SESHTAHVCODE_PY_CLI_CUSTOM_HEADERS")
    ...
    @cached_property
    def with_raw_response(self) -> SeshtahvcodePyCliWithRawResponse:
        return SeshtahvcodePyCliWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> SeshtahvcodePyCliWithStreamedResponse:
        return SeshtahvcodePyCliWithStreamedResponse(self)
...
class AsyncSeshtahvcodePyCli(AsyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncSeshtahvcodePyCli client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncSeshtahvcodePyCliWithRawResponse:
        return AsyncSeshtahvcodePyCliWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncSeshtahvcodePyCliWithStreamedResponse:
        return AsyncSeshtahvcodePyCliWithStreamedResponse(self)
...
class SeshtahvcodePyCliWithRawResponse:
    _client: SeshtahvcodePyCli

    def __init__(self, client: SeshtahvcodePyCli) -> None:
        self._client = client
...
class AsyncSeshtahvcodePyCliWithRawResponse:
    _client: AsyncSeshtahvcodePyCli

    def __init__(self, client: AsyncSeshtahvcodePyCli) -> None:
        self._client = client
...
class SeshtahvcodePyCliWithStreamedResponse:
    _client: SeshtahvcodePyCli
...
class AsyncSeshtahvcodePyCliWithStreamedResponse:
    _client: AsyncSeshtahvcodePyCli
...
AsyncClient = AsyncSeshtahvcodePyCli
